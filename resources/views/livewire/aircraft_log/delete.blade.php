...
new class extends Component
{
    ...
    public function mount(AircraftLog $aircraftLog): void
    {
        ...
        <div x-show="modalOpen" class="fixed top-0 left-0 z-[99] flex items-center justify-center w-screen h-screen" x-cloak>
            ...
            <div x-show="modalOpen"
                ...
                <div class="relative w-auto pb-8">
                    <p>Please confirm you want to delete this log.</p>
                </div>
                <div class="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2">
                    ...
                    <button @click="modalOpen=false" wire:click='delete' type="button" class="inline-flex items-center justify-center h-10 px-4 py-2 text-sm font-medium text-white transition-colors bg-red-500 border rounded-md hover:bg-red-800 active:bg-red-800 focus:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-900/60 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                </div>
            </div>
        </div>
    </template>
